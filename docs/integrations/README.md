...
This folder documents the direct dependencies, local pattern ports, and companion scaffolds that were added during the GitHub-candidate implementation pass.

- `env-nextjs.md`: typed env conventions and optional integration policy
